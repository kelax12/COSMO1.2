...
| 🟡 T-12 | Support | ~~Déployer `report-bug`~~ **fait le 2026-08-29, fumée passée**. Reste : poser `RESEND_API_KEY` dans les secrets Supabase, et le domaine d'envoi vérifié (T-03) sans quoi Resend refuse l'expéditeur | AM-2. Seul canal de support du produit | P1 | XS | T-03 | A + X | S1 |
