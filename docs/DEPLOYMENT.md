...
-->
> **Note d'audit** — **NON NOTÉ** : runbook opératoire. Les gardes qu'il décrit sont notées ailleurs (`uptime.yml`, `check:deploy`, `restore-drill` → Tests / CI), le document lui-même ne l'est pas.
