...
-->
> **Note d'audit** — **NON NOTÉ** : c'est une ÉTUDE, écrite contre les versions du 2026-09-03. Elle ne se note pas, elle périme — et `npm run check:study` échoue si une majeure qu'elle cite a bougé (C-108).
