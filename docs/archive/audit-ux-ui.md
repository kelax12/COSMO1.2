> ⚠️ **ARCHIVE — instantané daté du 2026-06-05, non maintenu.**
...
- ✅ **AM10** (onboarding progressif / modules simple vs avancé) — store `active-modules`, écran « Que voulez-vous gérer ? » au 1er login réel, nav filtrée (sidebar + tab bar + Plus), garde de routes `RequireModule`, réactivation dans Réglages › Modules. Démo inchangée (tout actif).
- ⏳ Non démarrés : **AM8** (design system `slate-*`→`--color-*`), **AM9** (échelle typo), **CM12** (Dashboard cockpit), **CM13** (découvrabilité unifiée), **CM14** (a11y agenda/clavier).
