# ⚠️ ARCHIVE — hero de la landing ENTREPRISE, version du 2026-09-22

> ⚠️ **Instantané daté, NON MAINTENU.** Ce fichier conserve le hero du parcours
> entreprise **tel qu'il était avant sa refonte du 2026-09-23** (maquettes 123 à
> 127, `Documents/COSMO-maquettes/landing-entreprise-hero.html`). Il n'est
> chargé par rien. **Le code fait foi contre cette archive.**

Rejouable depuis l'historique :
`git show 73825085:src/pages/landing/entreprise/EnterpriseHero.tsx` et
`git show 73825085:src/components/reactbits/CardSwap.tsx`.

## Pourquoi il a été remplacé

Le jeu de lumière et l'animation des cartes étaient appréciés et sont
**conservés** ; la mise en page et la typo étaient jugées génériques. Mesuré
sur la capture du 2026-09-23 :

- le faisceau (`raysOrigin="top-center"`) tombait **entre** les deux colonnes,
  sur du vide : la signature de la page n'éclairait rien ;
- titre en trois lignes blanc / gris / dégradé cyan, en Inter Bold 67 px,
  -3 % : le gabarit des landings générées ;
- mention de réassurance en `slate-600` sur `#08090C` : **2,6:1**, sous l'AA ;
- à 1440 px, la carte du fond de la pile sortait par le bord droit ;
- captures dans des cartes de 392 px : illisibles ;
- espaces parasites autour des segments surlignés, surlignage violet hors
  palette ;
- la pile tournait sans aucun moyen de l'arrêter (WCAG 2.2.2) ;
- aucune capture produit sur téléphone (`hidden lg:block`).
...
```json
{
  ...
  "line3": "avec facilité.",
  "subtitle": "Cosmo Entreprise se met en place en <hl>cinq étapes</hl>, de l'organigramme à la statistique d'équipe. Et chaque collaborateur garde <hl>le Cosmo personnel</hl> qu'il utilise déjà.",
  "cta": "Ouvrir la démo entreprise",
  "ctaAria": "Ouvrir la démonstration du mode entreprise, sans inscription",
  "ctaSecondary": "Voir les tarifs",
  "reassurance": "Jusqu'à 5 membres gratuitement · sans carte bancaire · réversible à tout moment",
  "reassuranceFree": "Gratuit pendant l'offre de lancement · sans carte bancaire · réversible à tout moment",
  "scroll": "Dérouler"
}
```
...
```json
{
  ...
  "line2": "your business",
  "line3": "with ease.",
  "subtitle": "Cosmo for companies sets up in <hl>five steps</hl>, from the org chart to team statistics. And every collaborator keeps <hl>the personal Cosmo</hl> they already use.",
  "cta": "Open the company demo",
  "ctaAria": "Open the company mode demonstration, no sign-up",
  "ctaSecondary": "See pricing",
  "reassurance": "Up to 5 members free · no credit card · reversible at any time",
  "reassuranceFree": "Free during the launch offer · no credit card · reversible at any time",
  "scroll": "Scroll"
}
```

## `src/pages/landing/entreprise/EnterpriseHero.tsx`
...
## `src/components/reactbits/CardSwap.tsx`
