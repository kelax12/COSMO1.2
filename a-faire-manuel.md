...
> 🔴 **Il n'en reste que DEUX depuis le 2026-09-12** : M-11 (`OPS_ALERT_WEBHOOK_URL`, secrets **Actions**) et M-12 (`CRON_SECRET`, Supabase **et** Actions, même valeur des deux côtés). ~~M-34 (`RATE_LIMIT_SALT`)~~ est posé, et le code qu'il débloquait tourne. Ce sont les seuls endroits où du code écrit, testé et committé ne produit **rien** en production.
>
