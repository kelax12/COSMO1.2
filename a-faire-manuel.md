...
>
> Un seul des trois a un ordre contraignant : **M-34 se pose avant** que `report-bug` soit redéployée, sinon le signalement de bug répond en erreur entre les deux gestes. Mesuré en base le 2026-09-08 : `consume_rate_limit` et la table `rate_limits` n'existent pas encore, la mig. `139` n'étant pas appliquée.
