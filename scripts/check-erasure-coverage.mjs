...
const DECISIONS = {
  ...
  // Audit entreprise 2026-09-23 (mig. 152 et 155) : rattachement direct à un
  // projet, suivis et préférences de notification. Aucune n'a de valeur une
  // fois le compte parti, elles disparaissent avec lui.
