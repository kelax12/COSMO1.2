...
<p>Oui : importez le fichier .xlsx dans Google Sheets (Fichier → Importer), les formules de progression sont conservées. Compatible aussi avec LibreOffice Calc.</p>
<h3>Puis-je le partager à mon équipe ?</h3>
<p>Oui, librement. Si chaque membre suit ses propres OKR, dupliquez la feuille « OKR équipe-startup » par personne.</p>
<h3>Faut-il donner son email pour télécharger ?</h3>
<p>Non. Le lien est direct, sans formulaire ni inscription — on préfère que vous jugiez le contenu, pas capturer votre adresse.</p>
`,
};
