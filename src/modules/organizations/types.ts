...
export interface OrgMember {
  ...
  /** Accès coupé, appartenance conservée (mig. 154). */
  suspendedAt?: string | null;
  /** Accès temporaire : il cesse à cette date (mig. 154). */
  accessExpiresAt?: string | null;
}

/** Un membre a-t-il ACCÈS aujourd'hui ? Miroir de `is_org_member` (mig. 154). */
