...
const TASK_LIST_COLUMNS =
  'id,name,priority,category,deadline,estimated_time,created_at,bookmarked,completed,completed_at,subtasks,kr_id,is_collaborative,pending_invites,user_id' as const;
