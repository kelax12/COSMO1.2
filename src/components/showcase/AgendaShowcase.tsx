                  ...
                  >
                    ...
                    <AnimatePresence>
                      {tooltipVisible && (
                        ...
                        >
                          <div className="flex items-center gap-1.5 bg-[rgb(var(--color-accent-solid))] text-[rgb(var(--color-accent-solid-foreground))] text-[10px] font-semibold px-2.5 py-1 rounded-full shadow-lg whitespace-nowrap">
