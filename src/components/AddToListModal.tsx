...
// ════════════════════════════════════════════════════════════════════════
// Desktop : modal centré, même style iOS-list (dot/check, pencil mode,
// draft inline, cycle couleur). Restauré depuis commit 1a81fb7.
// Pas de drag, pas de bottom-sheet — juste un modal centré.
// ════════════════════════════════════════════════════════════════════════
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between px-5 pt-5 pb-3 border-b border-[rgb(var(--color-border))] shrink-0">
              <div>
              ...
              <div className="flex items-center gap-0.5">
                ...
                <button
                  ...
                  onClick={onClose}
                  aria-label="Fermer"
                  className="w-9 h-9 flex items-center justify-center rounded-lg text-[rgb(var(--color-text-muted))] hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                >
                  <X size={18} />
                </button>
              </div>
            ...
            {/* Body */}
            <div data-scroll-area className="flex-1 overflow-y-auto px-5 py-3">
              ...
              <div className="divide-y divide-[rgb(var(--color-border))]">
                {manualLists.map((list) => {
                      ...
                      <div key={list.id} className="flex items-center gap-3 px-1 py-2.5">
                        ...
                        {isDeleting ? (
                          ...
                          <button
                            ...
                            className="w-9 h-9 flex items-center justify-center rounded-lg text-[rgb(var(--color-text-muted))] hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors shrink-0"
                          >
                            <Trash2 size={14} />
                          </button>
                        )}
                  ...
                  return (
                    <div
                      key={list.id}
                      className="flex items-center gap-3 px-1 py-3.5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer rounded-lg"
