// Créer / Éditer un OKR — refonte « test » en Sheet latéral shadcn (desktop).
// Réutilise onSubmit + getProgress du parent. Aucune logique métier nouvelle.
...
export default function OKRModalTest({ open, onOpenChange, categories, editingObjective, onSubmit }: OKRModalTestProps) {
