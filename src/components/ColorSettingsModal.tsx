  ...
  return (
    <>
      <ResponsiveSheet
        isOpen={isOpen}
        onClose={onClose}
        ariaLabel="Modifier les catégories"
        desktopMaxWidth={isNested ? 'sm:max-w-[510px]' : 'sm:max-w-[572px]'}
        desktopMaxHeight="85vh"
        zIndex={80}
        className="bg-white dark:bg-slate-800 monochrome:bg-neutral-900 text-slate-800 dark:text-white border-t sm:border border-slate-200 dark:border-slate-700 monochrome:border-neutral-700"
      >
      ...
      {/* Confirm delete — nested ResponsiveSheet */}
      <ResponsiveSheet
        ...
        zIndex={90}
        className="border-t sm:border monochrome:border-neutral-700"
        overlayClassName="monochrome:bg-black/60"
      >
