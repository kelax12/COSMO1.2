      ...
      {isLoading ? (
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-3">
          ...
          <button
            ...
            className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 transition-all"
          >
