...
const DashboardPage = lazyWithRetry(() => import('@/pages/DashboardPageSwitch'));
const TasksPage = lazyWithRetry(() => import('@/pages/TasksPageSwitch'));
const AgendaPage = lazyWithRetry(() => import('@/pages/AgendaPageSwitch'));
const HabitsPage = lazyWithRetry(() => import('@/pages/HabitsPage'));
const OKRPage = lazyWithRetry(() => import('@/pages/OKRPageSwitch'));
const StatisticsPage = lazyWithRetry(() => import('@/pages/StatisticsPageSwitch'));
const SettingsPage = lazyWithRetry(() => import('@/pages/SettingsPage'));
const PremiumPage = lazyWithRetry(() => import('@/pages/PremiumPageSwitch'));
